...
<CardGroup cols={2}>
  <Card title="Developer Support" icon="envelope" href="mailto:support@buildmarkets.com">
    Email [support@buildmarkets.com](mailto:support@buildmarkets.com) for integration help, technical questions, API issues, scope changes, SDK inquiries, and production access requests.
  </Card>

<Card
  title='System Status'
  icon='signal'
  href='https://status.buildmarkets.com'
>
  Check [status.buildmarkets.com](https://status.buildmarkets.com) for live
...
| API credential management                             | Partner Dashboard           |
| Sample code or open-source tooling                    | GitHub                      |
...
<Card title='SDKs and Code Generation' icon='code' href='/resources/sdks'>
  Generate a typed API client from the OpenAPI spec or use the ready-made auth
  helpers.
</Card>
