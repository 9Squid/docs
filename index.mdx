...
<div className="landing-dark-cta" style={{ marginTop: '0' }}>
  ...
  <img src="/candles-left.svg" className="landing-candles landing-candles-left" alt="" aria-hidden="true" />
  ...
  <img src="/candles-right.svg" className="landing-candles landing-candles-right" alt="" aria-hidden="true" />
