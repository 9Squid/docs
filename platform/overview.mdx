...
| **KYC** | Real KYC via Persona (US) / Sumsub (non-US); government ID required | Real KYC via Persona (US) / Sumsub (non-US); government ID required |
| **Orders** | Routed to a simulated exchange | Real order routing |
